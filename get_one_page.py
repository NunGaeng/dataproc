...
# 실행이 매번 느린 경우에는
driver_path = r"C:\Users\108-0\.wdm\drivers\chromedriver\win64\137.0.7151.68\chromedriver-win32\chromedriver.exe"
...
for idx, row in enumerate(rows):
    try:
        ...
        item = {
            "num" : doc_num, "title" : title, "dept" : dept, "date" : date,
            "content" : full_text
        }
        ...
        #table = driver.find_element(By.CSS_SELECTOR, "table.tb1.default.brd1")
